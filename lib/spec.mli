type ty = [
  | `Opam of [ `Build | `Lint of [ `Doc | `Opam ] | `Make of string list | `Script of string list] * Selection.t * string list
...
val opam :
  ...
  [ `Build | `Lint of [ `Doc | `Fmt | `Opam ] | `Make of string list | `Script of string list ] ->
  t
